  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved thought as @thought" do
        ...
        post :create, {:thought => { "body" => "invalid value" }}, valid_session
        assigns(:thought).should be_a_new(Thought)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested thought" do
        ...
        Thought.any_instance.should_receive(:update_attributes).with({ "body" => "MyString" })
        put :update, {:id => thought.to_param, :thought => { "body" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the thought as @thought" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Thought.any_instance.stub(:save).and_return(false)
        put :update, {:id => thought.to_param, :thought => { "body" => "invalid value" }}, valid_session
        assigns(:thought).should eq(thought)
      end
